...
<header id="header">
	<div class="row">
		<div class="header-topbar">
			...
			<?php
				/**
				 * @author Loja Miss Daisy
				 * @action_hook header_top_bar_contacts
				 * @uses contact links with icon
				 * @package lojamissdaisy-function
				*/

				do_action( 'styledstore_header_top_bar_contacts' );
			?>
				<?php if( styledstore_check_woocommerce_activation() ) { ?>
					<div class="lgn-ct">
						...
						<div class="header-top-cart mini-cart">
							<a class="st-cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'Veja o seu carrinho de comprar', 'styled-store' ); ?>"><?php esc_html_e( 'carrinho /', 'styled-store' ); echo WC()->cart->get_cart_total(); ?><i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i>
		...
		<div class="header">
			<div class="container col-md-12">
				<!-- logo -->
				<div class="logo-container sameheight col-xs-8 col-sm-6 col-md-6">
				...
				<!-- follow -->
				<div class="follow-container sameheight col-xs-4 col-sm-6 col-md-6">
					...
					<?php
						...
						*/
						...
						do_action( 'lojamissdaisy_header_top_bar_social_links' );
					?>
			...
			<?php
				...
				*/
				...
				do_action( 'lojamissdaisy_header_navigation_menu' );
			?>
